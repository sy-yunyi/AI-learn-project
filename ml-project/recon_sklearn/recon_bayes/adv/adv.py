...
def local_words(feed_0, feed_1):
    ...
    for doc_index in test_set:
        ...
        prediction_proba = clf.predict_log_proba([np.array(word_vector)])
        # p = []
        # p.append(prediction_proba[0].tolist())
        # print(p[0][0])
        p_0_v.append(prediction_proba[0][0])
        p_1_v.append(prediction_proba[0][1])
        # print(p_1_v_i)
